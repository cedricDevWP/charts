...
class SimpleLegendEntryLayout implements LegendEntryLayout {
  ...
  Widget createSymbol(BuildContext context, common.LegendEntry legendEntry, TappableLegend legend, bool isHidden) {
    ...
    final SymbolRendererBuilder symbolRendererBuilder = legendEntry.symbolRenderer! is SymbolRendererBuilder ? legendEntry.symbolRenderer! as SymbolRendererBuilder : new SymbolRendererCanvas(legendEntry.symbolRenderer!, legendEntry.dashPattern);
  ...
  TextStyle _convertTextStyle(bool isHidden, BuildContext context, common.TextStyleSpec? textStyle) {
    ...
    return new TextStyle(inherit: true, fontFamily: textStyle?.fontFamily, fontSize: textStyle?.fontSize != null ? textStyle!.fontSize!.toDouble() : null, color: color);
  }
}
